...
public class Road {
	...
	/**
	 * Constructor to build road between two settlements. This fulfils the class diagram
	...
	public String toString() {
		String result = name + ":" + classification + ":" + length + ":" + sourceSettlement + ":" + destinationSettlement;
		return result;
	}
}
